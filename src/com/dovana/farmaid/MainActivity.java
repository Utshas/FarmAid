...
MediaPlayer mp;
TextView markettext,diseasetext,fertilizertext,govttext;
	 private AudioManager audioManager = null; 
	ImageButton btnSound;
	Integer i=0,j=0;
	LinearLayout crop_market,diseases_l,fertilizer_l,govt_l;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		govt_l=(LinearLayout) findViewById(R.id.govt_l);
		...
		govttext=(TextView)findViewById(R.id.govt_text);
